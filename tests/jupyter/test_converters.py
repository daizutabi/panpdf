...
def test_convert_image_to_code_block(store: Store, image_factory, fmt: str):
    from panpdf.jupyter.converters import convert_image_to_code_block
...
def test_convert_image_base64(store: Store, image_factory):
    from panpdf.jupyter.converters import convert_image_base64
...
def test_convert_image_pdf(store: Store, image_factory):
    from panpdf.jupyter.converters import convert_image_pdf
...
def test_convert_image_svg(store: Store, image_factory):
    from panpdf.jupyter.converters import convert_image_svg
...
def test_convert_image_pgf(store: Store, image_factory):
    from panpdf.jupyter.converters import convert_image_pgf
...
def test_convert_image(store: Store, image_factory):
    from panpdf.jupyter.converters import convert_image
